...
Config.SkinnableAnimals = {
    ...
    [-1797625440] = { name = "Armadillo", givenItem = { "stringy", "armadilloc", "armadillos" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Stringy meat", "Armadillo claws", "Armadillo pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_armadillo", action = "Skinned" },
    [-1170118274] = { name = "American Badger", givenItem = { "stringy", "scentg", "badgers" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Stringy meat", "Scent glad", "Badger skin" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_badger", action = "Skinned" },
    [1755643085]  = { name = "American Pronghorn Doe", givenItem = { "venison", "prongs" }, givenAmount = { 1, 1 }, givenDisplay = { "Vension", "Pronghorn pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_pronghorn", action = "Skinned" },
    [-1124266369] = { name = "Bear", givenItem = { "biggame", "bearc", "beart" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Bear claws", "Bear tooth" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_bear", action = "Skinned" },
    [-1568716381] = { name = "Big Horn Ram", givenItem = { "Mutton", "ramhorn", "rams" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Mutton", "Ramhorn", "Ram Pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_bighornram", action = "Skinned" },
    [-1963605336] = { name = "Buck", givenItem = { "buckantler", "bucks", "venison" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Venison", "Buck Antlers", "Buck pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_buck", action = "Skinned" },
    [1556473961]  = { name = "Bison", givenItem = { "beef", "bisonhorn", "bisons" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Beef", "Bison Horn", "Bison pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_buffal", action = "Skinned" },
    [367637652]   = { name = "Bison", givenItem = { "beef", "bisonhorn", "bisons" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Beef", "Bison Horn", "Bison pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_buffal", action = "Skinned" },
    [1957001316]  = { name = "Bull", givenItem = { "beef", "bullhorn", "bulls" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Beef", "Bull horn", "Bull pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_bull_angus", action = "Skinned" },
    [1110710183]  = { name = "Deer", givenItem = { "venison", "deerheart", "deerskin" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Vension", "Deer heart", "Deer pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_deer", action = "Skinned", type = "satchel_textures" },
    [-1003616053] = { name = "Duck", givenItem = { "bird", "duckfat", "birdfeather" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Duck fat", "Birdfeather" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_duck_mallard", action = "Skinned", type = "satchel_textures" },
    [1459778951]  = { name = "Eagle", givenItem = { "bird", "eaglef", "eaglet" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Eagle feather", "Eagle claws" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_eagle_bald", action = "Skinned", type = "satchel_textures" },
    [831859211]   = { name = "Egret", givenItem = { "bird", "egretf", "egretb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Egret feather", "Egret beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_egret_little", action = "Skinned", type = "satchel_textures" },
    [252669332]   = { name = "American Red Fox", givenItem = { "game", "foxt", "foxskin" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Game Meat", "Fox tooth", "Foxskin" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_fox_red", action = "Skinned" },
    [-1143398950] = { name = "Big Grey Wolf", givenItem = { "game", "wolftooth", "wolfpelt", "wolfheart" }, givenAmount = { 1, 1, 1, 1 }, givenDisplay = { "Game Meat", "wolf  tooth", "Wolf skin", "Wolf Heart" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_wolf_gray", action = "Skinned" },
    [-885451903]  = { name = "Medium Grey Wolf", givenItem = { "game", "wolftooth", "wolfpelt", "wolfheart" }, givenAmount = { 1, 1, 1, 1 }, givenDisplay = { "Game Meat", "wolf  tooth", "Wolf skin", "Wolf Heart" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_wolf_timber", action = "Skinned" },
    [-829273561]  = { name = "Small Grey Wolf", givenItem = { "game", "wolftooth", "wolfpelt", "wolfheart" }, givenAmount = { 1, 1, 1, 1 }, givenDisplay = { "Game Meat", "wolf  tooth", "Wolf skin", "Wolf Heart" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_wolf_timber", action = "Skinned" },
    [1104697660]  = { name = "Vulture", givenItem = { "bird", "condorf", "condorb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Vulture feather", "Vulture beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_vulture_western", action = "Skinned", type = "satchel_textures" },
    [-407730502]  = { name = "Snapping Turtle", givenItem = { "stringy", "turtleshell", "turtlet" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Stringy meat", "Turtle shell", "Turtle tooth" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_snapping_turtle", action = "Skinned", type = "satchel_textures" },
    [-466054788]  = { name = "Wild Turkey", givenItem = { "bird", "turkeyf", "turkeyb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Turkey feather", "Turkey beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_turkey_eastern", action = "Skinned", type = "satchel_textures" },
    [-2011226991] = { name = "Wild Turkey", givenItem = { "bird", "turkeyf", "turkeyb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Turkey feather", "Turkey beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_turkey_eastern", action = "Skinned", type = "satchel_textures" },
    [-166054593]  = { name = "Wild Turkey", givenItem = { "bird", "turkeyf", "turkeyb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Turkey feather", "Turkey beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_turkey_eastern", action = "Skinned", type = "satchel_textures" },
    [-22968827]   = { name = "Water Snake", givenItem = { "wsnakeskin", "snaket", "stringy" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Watersnake pelt", "Snake tooth", "Stringy meat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_snakewater", action = "Skinned", type = "satchel_textures" },
    [-229688157]  = { name = "CottonMouth Water Snake", givenItem = { "wsnakeskin", "snaket", "stringy" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Watersnake pelt", "Snake tooth", "Stringy meat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_snakewater", action = "Skinned", type = "satchel_textures" },
    [-1790499186] = { name = "Snake Red Boa", givenItem = { "boaskin", "snaket", "stringy" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Boa Snake pelt", "Snake tooth", "Stringy meat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_snakeredboa", action = "Skinned", type = "satchel_textures" },
    [1464167925]  = { name = "Snake Fer-De-Lance", givenItem = { "snaket", "stringy", "asnakes" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Fer de Lance Snake pelt", "Snake tooth", "Stringy meat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_snakeferdelance", action = "Skinned", type = "satchel_textures" },
    [846659001]   = { name = "Black-Tailed Rattlesnake", givenItem = { "snaket", "stringy", "fsnakes" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Black rattletail Snake pelt", "Snake tooth", "Stringy meat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_snakeblacktailrattle", action = "Skinned", type = "satchel_textures" },
    [545068538]   = { name = "Western Rattlesnake", givenItem = { "snaket", "stringy", "fsnakes" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Black rattletail Snake pelt", "Snake tooth", "Stringy meat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_snakeblacktailrattle", action = "Skinned", type = "satchel_textures" },
    [-121266332]  = { name = "Striped Skunk", givenItem = { "stringy", "scentg", "badgers" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Stringy meat", "Scent glad", "Badger skin" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_skunk", action = "Skinned", type = "satchel_textures" },
    [40345436]    = { name = "Merino Sheep", givenItem = { "Mutton", "wool", "sheephead" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Mutton", "Wool", "Sheep head" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_sheep", action = "Skinned", type = "satchel_textures" },
    [-164963696]  = { name = "Herring Seagull", givenItem = { "bird", "seagullf", "seagullb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Seagull feather", "Seagull beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_seagull_herring", action = "Skinned", type = "satchel_textures" },
    [-1076508705] = { name = "Roseate Spoonbill", givenItem = { "bird", "rspoonf", "rspoonb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Roseta Spoonbill feather", "Roseta Spoonbill beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_roseatespoonbill", action = "Skinned", type = "satchel_textures" },
    [2023522846]  = { name = "Dominique Rooster", givenItem = { "bird", "cockf", "cockc" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Rooster feather", "Rooster claws" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_rooster_dominique", action = "Skinned", type = "satchel_textures" },
    [-466687768]  = { name = "Red-Footed Booby", givenItem = { "bird", "boobyf", "boobyb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Red-footed booby feather", "Red-footed booby beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_red_footed_booby", action = "Skinned", type = "satchel_textures" },
    [-575340245]  = { name = "Wester Raven", givenItem = { "bird", "ravenf", "ravenc" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Raven feather", "Raven beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_raven", action = "Skinned", type = "satchel_textures" },
    [1458540991]  = { name = "North American Racoon", givenItem = { "game", "raccoont", "raccoons" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Game Meat", "Raccoon tooth", "Raccoon skin" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_raccoon", action = "Skinned", type = "satchel_textures" },
    [-541762431]  = { name = "Black-Tailed Jackrabbit", givenItem = { "game", "rabbits", "rabbitpaw" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Game Meat", "Rabbit skin", "Rabbit foot" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_rabbit", action = "Skinned", type = "satchel_textures" },
    [2079703102]  = { name = "Greater Prairie Chicken", givenItem = { "bird", "prairif", "prairib" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Prairi chicken feather", "Prairi chicken beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_prairie_chicken", action = "Skinned", type = "satchel_textures" },
    [-1414989025] = { name = "Wirginia Possum", givenItem = { "stringy", "opossumc", "opossums" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Opossum claws", "Stringy meat", "Opossum skin" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_opossum", action = "Skinned", type = "satchel_textures" },
    [1007418994]  = { name = "Berkshire Pig", givenItem = { "pork", "pigs", "porkfat" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Pork", "Pig pelt", "Pig fat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_pig_berkshire", action = "Skinned", type = "satchel_textures" },
    [1416324601]  = { name = "Ring-Necked Pheasant", givenItem = { "bird", "peasantf", "peasantb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Peasant feather", "Peasant beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_pheasant_ringneck", action = "Skinned", type = "satchel_textures" },
    [1265966684]  = { name = "American White Pelican", givenItem = { "bird", "pelicanf", "pelicanb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Pelican feather", "Pelican beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_pelican_white", action = "Skinned", type = "satchel_textures" },
    [-1797450568] = { name = "Blue And Yellow Macaw", givenItem = { "bird" }, givenAmount = { 1 }, givenDisplay = { "Bird meat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_parrot_blueyellow", action = "Skinned", type = "satchel_textures" },
    [1654513481]  = { name = "Panther", givenItem = { "biggame", "panthers", "panthere" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Panther pelt", "Panther eyes" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_panther", action = "Skinned", type = "satchel_textures" },
    [120598262]   = { name = "Californian Condor", givenItem = { "bird", "kcondorf", "kcondorb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Condor feather", "Condor beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_condor", action = "Skinned", type = "satchel_textures" },
    [-2063183075] = { name = "Dominique Chicken", givenItem = { "bird", "chickenf", "chickenheart" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Chicken feather", "Chicken heart" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_chicken_dominique", action = "Skinned", type = "satchel_textures" },
    [-2073130256] = { name = "Double-Crested Cormorant", givenItem = { "bird", "bbirdf", "bbirdb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Cormorant feather", "Cormorant beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_cormorant", action = "Skinned", type = "satchel_textures" },
    [90264823]    = { name = "Cougar", givenItem = { "biggame", "cougars", "cougarf" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Cougar skin", "Cougar tooth" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_bobcat", action = "Skinned", type = "satchel_textures" },
    [-50684386]   = { name = "Florida Cracker Cow", givenItem = { "beef", "cows", "cowh" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Beef", "Cow pelt", "Cow horn" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_cow", action = "Skinned", type = "satchel_textures" },
    [480688259]   = { name = "Coyote", givenItem = { "game", "coyotes", "coyotef" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Game Meat", "Coyote skin", "Coyote tooth" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_coyote", action = "Skinned", type = "satchel_textures" },
    [-564099192]  = { name = "Whooping Crane", givenItem = { "bird", "daruf", "darub" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Crane feather", "Crane beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_crane", action = "Skinned", type = "satchel_textures" },
    [45741642]    = { name = "Gila Monster", givenItem = { "herptile", "lizards", "lizardl" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Herptile meat", "Lizard pelt", "Lizard foot" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_gila_monster", action = "Skinned", type = "satchel_textures" },
    [-753902995]  = { name = "Alpine Goat", givenItem = { "game", "goats", "goathead" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Game Meat", "Goat pelt", "Goat head" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_goat", action = "Skinned", type = "satchel_textures" },
    [723190474]   = { name = "Canada Goose", givenItem = { "bird", "goosef", "gooseb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Goose feather", "Goose beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_goosecanada", action = "Skinned", type = "satchel_textures" },
    [-2145890973] = { name = "Ferruinous Hawk", givenItem = { "bird", "hawkf", "hawkt" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Hawk feather", "Hawk claws" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_hawk_roughlegged", action = "Skinned", type = "satchel_textures" },
    [1095117488]  = { name = "Great Blue Heron", givenItem = { "bird", "kbirdf", "kbirdb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Tricolor heron feather", "Tricolor heron beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_loon_yellowbilled", action = "Skinned", type = "satchel_textures" },
    [-1854059305] = { name = "Green Iguana", givenItem = { "herptile", "gleguans", "lizardl" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Herptile meat", "Green Iguana pelt", "Lizard foot" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_iguana", action = "Skinned", type = "satchel_textures" },
    [-593056309]  = { name = "Desert Iguana", givenItem = { "herptile", "dleguans", "lizardl" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Herptile meat", "Desert Iguana pelt", "Lizard foot" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_iguanadesert", action = "Skinned", type = "satchel_textures" },
    [1751700893]  = { name = "Peccary Pig", givenItem = { "pork", "pecaris", "porkfat" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Pork", "Peccary skin", "Pig fat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_pig_oldspot", action = "Skinned", type = "satchel_textures" },
    [386506078]   = { name = "Common Loon", givenItem = { "bird", "loonf", "loonb" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Common loon feather", "Common loon beak" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_loon_common", action = "Skinned", type = "satchel_textures" },
    [-1098441944] = { name = "Moose", givenItem = { "biggame", "mooseantler", "mooses" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Moose Antlers", "Moose pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_moose", action = "Skinned", type = "satchel_textures" },
    [-1134449699] = { name = "American Muskrat", givenItem = { "stringy", "muskrats", "scentg" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Stringy meat", "Muskrat skin", "cent glad" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_muskrat", action = "Skinned", type = "satchel_textures" },
    [-86244272]   = { name = "Great Horned Owl", givenItem = { "bird", "owlf", "owlt" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bird meat", "Owl feather", "Owl claws" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_owl_great", action = "Skinned", type = "satchel_textures" },
    [556355544]   = { name = "Angus Ox", givenItem = { "biggame", "oxhorn", "oxs" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Angus Ox horn", "Ox Pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_ox_angus", action = "Skinned", type = "satchel_textures" },
    [-1892280447] = { name = "Alligator Small", givenItem = { "game", "aligatorto", "aligators" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Game meat", "Aligator Tooth", "Aligator Pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_alligator", action = "Skinned", type = "satchel_textures" },
    [-2004866590] = { name = "Alligator", givenItem = { "biggame", "aligatorto", "aligators" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "BigGame meat", "Aligator Tooth", "Aligator Pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_alligator_medium", action = "Skinned", type = "satchel_textures" },
    [-1295720802] = { name = "Northen American Alligator", givenItem = { "biggame", "aligatorto", "aligators" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "BigGame meat", "Aligator Tooth", "Aligator Pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_alligator_medium", action = "Skinned", type = "satchel_textures" },
    [759906147]   = { name = "North American Beaver", givenItem = { "game", "beavertail", "beawers" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Game meat", "Beaver tail", "Beaver pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_beaver", action = "Skinned", type = "satchel_textures" },
    [730092646]   = { name = "American Black Bear", givenItem = { "bearc", "bbears", "biggame" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Bear claws", "Black Bear skin", "Big Game Meat" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_bear_black", action = "Skinned", type = "satchel_textures" },
    [195700131]   = { name = "Hereford Bull", givenItem = { "beef", "bullhorn", "bulls" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Beef", "Bull horn", "Bull pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "animal_bull_hereford", action = "Skinned", type = "satchel_textures" },
    ...
    [-1433814131] = { name = "Legendary Maza Cougar", givenItem = { "biggame", "legcougars2", "cougarf" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Legendary Maza Cougar pelt", "Cougar tooth" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "mp_animal_cougar_legendary_02", action = "Skinned", type = "inventory_items_mp" },
    ...
    [-1189368951] = { name = "Legendary Ghost Panther", givenItem = { "biggame", "legpanthers2", "panthere" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Legendary Ghost Panther pelt", "Panther eyes" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "mp_animal_panther_legendary_02", action = "Skinned", type = "inventory_items_mp" },
    ...
    [-551216071] = { name = "Legendary Owiza Bear", givenItem = { "biggame", "legbears2", "bearc" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Legendary Owiza Bear pelt", "Bear Claw" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "mp_animal_bear_legendary_01", action = "Skinned", type = "inventory_items_mp" },
    ...
    [-117665949] = { name = "Legendary Snowflake Moose", givenItem = { "biggame", "mooseantler", "legmooses1" }, givenAmount = { 1, 1, 1 }, givenDisplay = { "Big Game Meat", "Moose Antlers", "Legendary Snowflake Moose pelt" }, money = 0, gold = 0, rolPoints = 0, xp = 1, texture = "mp_animal_moose_legendary_01", action = "Skinned", type = "inventory_items_mp" },
}
